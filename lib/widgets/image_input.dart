...
class _ImageInputState extends State<ImageInput> {
  ...
  Future<void> getImage() async {
    final pickedFile = await _picker.pickImage(source: ImageSource.camera, maxWidth: 600);
    ...
    return Row(
      children: <Widget>[
        Container(
          ...
          Image.file(_storedImage!, width: double.infinity, fit: BoxFit.cover,) : const Text('No image Taken', textAlign: TextAlign.center,),
